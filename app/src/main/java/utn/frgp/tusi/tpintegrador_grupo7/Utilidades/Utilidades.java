...
public class Utilidades {
    ...
    //Constantes campos tabla Formato
    public static final String TABLA_FORMATO="formato";
    public static final String CAMPO_ID_FORMATO="id";
    public static final String CAMPO_TIPO_FORMATO="tipo";

    public static final String CREAR_TABLA_FORMATO="CREATE TABLE " + TABLA_FORMATO + "(" + CAMPO_ID_FORMATO + " integer primary key autoincrement, " + CAMPO_TIPO_FORMATO + " text)";
    ...
    public static final String CAMPO_FORMATO_CONFIG="id_formato";


    public static final String CREAR_TABLA_CONFIG="CREATE TABLE " + TABLA_CONFIG + "(" + CAMPO_COLOR_CONFIG + " integer, " + CAMPO_COLORBOTON_CONFIG + " integer, "+ CAMPO_TIPOGRAFIA_CONFIG + " integer, "+ CAMPO_TAMANO_CONFIG + " integer, " + CAMPO_ESTADO_VIBRACION + " integer, " + CAMPO_ESTADO_SONIDO + " integer, " + CAMPO_DECIMAL_CONFIG + " integer, " + CAMPO_FORMATO_CONFIG + " integer, " +
            ...
            "FOREIGN KEY ("+CAMPO_FORMATO_CONFIG+") REFERENCES "+ TABLA_FORMATO +"("+CAMPO_ID_FORMATO+"))";
    ...
    public static final String INSERTAR_TABLA_CONFIGURACION="INSERT INTO " + TABLA_CONFIG + "(" + CAMPO_COLOR_CONFIG + ", " + CAMPO_COLORBOTON_CONFIG + ", " + CAMPO_TIPOGRAFIA_CONFIG + ", " + CAMPO_TAMANO_CONFIG + ", " + CAMPO_ESTADO_VIBRACION + ", " + CAMPO_ESTADO_SONIDO + ", " + CAMPO_DECIMAL_CONFIG + ", " + CAMPO_FORMATO_CONFIG + ") VALUES (4,5,1,2,1,1,2,1)";
